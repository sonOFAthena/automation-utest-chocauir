...
Feature: Utest Website
  ...
  Scenario: User Fill out the registration form
    ...
    When he does the registration
      ...
      | Bob     | Collen      | bobcollen9@gmail.com | December/31/1990 | Spanish     | Colombia   | Medellin | Medellin, Antioquia, Colombia | 050000     | Huawei       | Y9s           | Android 10 | nqE24aqsow!UfS&N!ZZ2GU*R*Ju!!@^%Upadqp7!QhUGF3R^^cvSQsMib8vY2Z5u |
